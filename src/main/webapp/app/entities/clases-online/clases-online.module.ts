...
import { ClasesOnlineDetailClaseComponent } from './detailClase/clases-online-detailClase.component';
...
@NgModule({
  ...
  declarations: [ClasesOnlineComponent, ClasesOnlineDetailComponent, ClasesOnlineUpdateComponent, ClasesOnlineDeleteDialogComponent,ClasesOnlineDetailClaseComponent,ComentarioClaseUpdateComponent,ComentarioCADMINUpdateComponent],
})
